...
from assistenten.functions.schicht_functions import get_sliced_schichten_by_asn, add_feste_schichten_asn, \
    sort_schicht_data_by_beginn, sort_schichten_in_templates, add_feste_schichten_as, get_sliced_schichten_by_as
...
class AbstractDienstplanView(LoginRequiredMixin, TemplateView):
    model = Schicht
