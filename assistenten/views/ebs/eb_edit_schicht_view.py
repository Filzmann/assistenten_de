...
class EbCreateSchichtView(LoginRequiredMixin, CreateView):
    ...
    def get_form_kwargs(self):
        kwargs = super(EbCreateSchichtView, self).get_form_kwargs()
...
class EbEditSchichtView(LoginRequiredMixin, UpdateView):
    template_name = "assistenten/ebs/eb_edit_schicht.html"
    ...
    def get_form_kwargs(self):
        kwargs = super(EbEditSchichtView, self).get_form_kwargs()
...
class DeleteSchichtView(LoginRequiredMixin, DeleteView):
    ...
    def get_success_url(self):
        ...
        elif usergroup == "Einsatzbegleitungen":
            return reverse_lazy('eb_dienstplan')
